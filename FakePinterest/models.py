...
@login_manager.user_loader  # Carrega o usuário
...
class Usuario(database.Model, UserMixin):
    ...
    fotos = database.relationship(
        "Foto", backref="usuario", lazy=True
    )  # Define quais fotos esão relacionadas com qual usuário
...
# Informações do bd usadas na hora de criá-lo
